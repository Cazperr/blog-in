      ...
      <form className="writeForm" onSubmit={handleSubmit}>
        <div className="writeFormGroup">
          <label htmlFor="fileInput" className="inputImagePlus">
            <i className="writeIcon fas fa-plus"></i>Imagen
          </label>
          <input
            id="fileInput"
            type="file"
        ...
        <div className="categoriasSelect">
          <select className="selectEdit" name="categorias" id="categorias" autoFocus={true} onChange={e => setCategories(e.target.value)}>
